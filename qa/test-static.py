...
check('contact chooser has explicit routes', '/contact /contact/index.html 200' in (root/'_redirects').read_text() and '/contact/ /contact/index.html 200' in (root/'_redirects').read_text())
...
check('buyer exact redirects exist', '/buyer /buyer/index.html 200' in (root/'_redirects').read_text() and '/buyer/ /buyer/index.html 200' in (root/'_redirects').read_text())
check('legacy Home alternate is absent', not (root/'home/Wowindex.html').exists())
check('legacy Home alternate permanently redirects', '/home/Wowindex.html /home/ 301' in (root/'_redirects').read_text())
