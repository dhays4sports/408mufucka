...
check('contact route has exact deployment rewrites', ['/contact /contact/index.html 200','/contact/ /contact/index.html 200'].every(line => read('_redirects').includes(line)));
